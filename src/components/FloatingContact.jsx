...
export default function FloatingContact() {
  ...
  return (
    <div 
      // 🔥 FIX 1: Lowered z-index to z-40 so the Nav Menu sits on top. 
      // 🔥 FIX 2: Responsive positioning and gap (tighter on mobile).
        ...
        {isOpen && (
          ...
          >
            ...
            <motion.a
              ...
              // 🔥 FIX 3: Smaller padding on mobile (p-3 vs md:p-4)
